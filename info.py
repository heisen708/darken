...
BOT_TOKEN = environ.get('BOT_TOKEN', "7933550773:AAF7cjYRJIdoX90BNwObVcllXVqvyhH3o7U")

CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://files.catbox.moe/ld1oa5.jpg')).split() 
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://i.ibb.co/yFZ5Cvrz/temp.jpg'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002574873706'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002671798198')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002512625570') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002587184746') 
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/viberox') 
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TylerDurden_T4')
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/movie_Film_series1')

AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002275381683 -1002665145530") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002275381683 -1002665145530') # add multiple channels here, separated by single space
AUTH_REQ_CHANNEL = [int(ch) for ch in AUTH_REQ_CHANNEL.strip().split()] if AUTH_REQ_CHANNEL else []

IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002647011471'))
...
SHORTENER_API = environ.get("SHORTENER_API", "54528f37e15baa266842ef63286e58ca152896cb")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "softurl.in")

SHORTENER_API2 = environ.get("SHORTENER_API2", "0123cbbcb7da6b4d5eb066e3f5545ef53ecee5bd")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "shortxlinks.com")

SHORTENER_API3 = environ.get("SHORTENER_API3", "54528f37e15baa266842ef63286e58ca152896cb")
...
PING_INTERVAL = int(environ.get("PING_INTERVAL", "1200"))  # 20 mnutes
if 'DYNO' in environ:
    ON_HEROKU = True
